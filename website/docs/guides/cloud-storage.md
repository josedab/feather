...
description: Extend Feather's warm tier with cloud-native storage solutions like DynamoDB, S3, GCS, and Bigtable.
---
...
flowchart TB
    ...
    subgraph Warm["Warm Tier (Local Disk)"]
        direction LR
        W1["BadgerDB"]
        W2["Historical versions"]
        W3["1-10ms latency"]
    end

    subgraph Cold["Cold Tier (Cloud)"]
        direction LR
        C1["DynamoDB/Bigtable"]
        C2["S3/GCS Archive"]
        C3["10-100ms latency"]
    end
...
| Strategy | Savings |
|----------|---------|
| On-Demand to Provisioned | 30-70% for stable workloads |
...
- [Architecture Overview](../concepts/architecture) - Storage tier design
- [Performance Guide](./performance) - Optimization strategies
- [Deployment Guide](./deployment) - Cloud deployment
