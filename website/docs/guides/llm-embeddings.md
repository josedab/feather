...
description: Generate and serve feature embeddings using large language models from OpenAI, Ollama, and HuggingFace.
---
...
```mermaid
flowchart TB
    Input[Input Text] --> Chunker
    Chunker[Chunker] --> Dedup[Deduplication]
    Dedup --> Queue[Batch Queue]
    Queue --> Provider[Provider API]
...
- [Discovery Guide](../guides/freshness) - AI-powered feature discovery
- [Vector Search](./vector-search) - Vector similarity API
