---
sidebar_position: 2
title: "ADR-0001: Tiered Storage Architecture"
description: Two-tier storage design with hot (memory) and warm (disk) layers.
---
...
1. **Speed**: ML inference requires features in sub-1ms to avoid becoming a bottleneck
