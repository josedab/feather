...
- [Aggregation Engine](./architecture.md#aggregation-engine) - Batch aggregations
- [Kafka Integration](./deployment.md#kafka-setup) - Kafka configuration
